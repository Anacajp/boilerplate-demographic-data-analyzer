...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_values = df.groupby(by=['native-country'])['salary'].apply(lambda x : (x == '>50K').mean() * 100)
    ...
    top_IN_occupation = df[df['native-country'] == 'India'].groupby(by= 'occupation')['salary'].apply(lambda x: (x == '>50K').mean()).idxmax() 
